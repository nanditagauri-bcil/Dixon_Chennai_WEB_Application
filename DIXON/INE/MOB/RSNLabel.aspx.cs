...
{
    public partial class RSNLabel : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["Name"] != null && Request.QueryString["Name"] != string.Empty)
                {
                    ...
                    if (Request.QueryString["Name"].Contains("Temporary"))
                    {
                        lblHeader.Text = "Temporary Label Printing";
                    }
                ...
                if (Session["usertype"].ToString() != "ADMIN")
                {
                    ...
                    _strRights = CommonHelper.GetRights("Temporary Label Printing", (DataTable)Session["USER_RIGHTS"]);
        ...
        protected void txtScanHere_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string _Result = blobj.blProductLabelPrinting(plob);
                Message = _Result;
