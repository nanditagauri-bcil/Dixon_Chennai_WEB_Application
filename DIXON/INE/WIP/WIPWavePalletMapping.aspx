<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" 
    CodeBehind="WIPWavePalletMapping.aspx.cs"
    Inherits="DIXON.INE.WIP.WIPWavePalletMapping" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Wave Pallet Mapping</h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Wave Pallet Mapping</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Scan Pallet ID : </label>
                                <asp:TextBox ID="txtpalletid" runat="server" placeholder="Scan PalletID" autocomplete="off" class="form-control flat"
                                    Style="width: 100%;" MaxLength="100" OnTextChanged="txtpalletid_TextChanged" AutoPostBack="true">                                  
                                </asp:TextBox>
                            </div>
                            <div class="form-group">
