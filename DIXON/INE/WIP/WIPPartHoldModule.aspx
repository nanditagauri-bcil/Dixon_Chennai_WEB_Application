<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WIPPartHoldModule.aspx.cs"
    Inherits="DIXON.INE.WIP.WIPPartHoldModule" %>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Part Hold Process</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Select Hold/Block Process : </label>
                            ...
                            <div id="divReason" class="form-group" runat="server" visible="false">
