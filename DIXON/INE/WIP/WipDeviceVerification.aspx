<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WipDeviceVerification.aspx.cs" Inherits="DIXON.INE.WIP.WipDeviceVerification" %>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group" runat="server" id="lblDevice2QR"> 
                                    <label>Scan Additional QR Code: </label>
                                    <asp:TextBox ID="txtDevice2QR" runat="server" placeholder=" Enter Additional QR Code" autocomplete="off" class="form-control"
                                        Style="width: 100%;" MaxLength="1000" OnTextChanged="txtScanDevice2QR_TextChanged" AutoPostBack="true">
                                    </asp:TextBox> 
                            </div>
