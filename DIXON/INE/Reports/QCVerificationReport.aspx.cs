...
{
    public partial class QCVerificationReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["usertype"].ToString() != "ADMIN")
            {
                ...
                _strRights = CommonHelper.GetRights("QC Verification Report", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindFGItemCode()
        {
            try
            {
                BL_QCVerificationReport blobj;
                blobj = new BL_QCVerificationReport();
        ...
        private void ShowGridData()
        {
            try
            {
                ...
                BL_QCVerificationReport blobj = new BL_QCVerificationReport();
                DataTable dtTrackingData = blobj.GetReport(txtFromDate.Text, txtToDate.Text, drpFGItemCode.Text, sPCBID);
                if (dtTrackingData.Rows.Count > 0)
                {
                    ...
                    CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtMessage,
                          System.Reflection.MethodBase.GetCurrentMethod().Name, "QC Verification Report No of records :" + dtTrackingData.Rows.Count);

                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportDataSource datasource = new ReportDataSource();
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/QCVerificationReport.rdlc");
