...
{
    public partial class WIPRsnAndMacIDMappingReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string _strRights = CommonHelper.GetRights("WIP Rsn And MacID Mapping Report", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindFGItemCode()
        {
            try
            {
                BL_WIPRsn_And_MacID_Mapping_Report blobj;
                blobj = new BL_WIPRsn_And_MacID_Mapping_Report();
                ...
                {
                    CommonHelper.ShowMessage("No fg itemcode found in unbind.", msginfo, CommonHelper.MessageType.Info.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        private void ShowGridData()
        {
            try
            {
                ...
                BL_WIPRsn_And_MacID_Mapping_Report blobj = new BL_WIPRsn_And_MacID_Mapping_Report();
                DataTable dt = blobj.GetReport(txtFromDate.Text.Trim(), txtToDate.Text.Trim(), sPCBID
                    , drpFGItemCode.SelectedItem.Text.Trim());
                if (dt.Rows.Count > 0)
                {
                    ...
                    CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtMessage,
                          System.Reflection.MethodBase.GetCurrentMethod().Name, "WIPRsn And MacID Mapping Report No of records :" + dt.Rows.Count);

                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportDataSource datasource = new ReportDataSource();
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WIPRsnAndMacIDMappingReport.rdlc");
