...
{
    public partial class WallMountKitReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["usertype"].ToString() != "ADMIN")
            {
                ...
                _strRights = CommonHelper.GetRights("Wall Mount Kit Report", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindFGItemCode()
        {
            try
            {
                BL_WallMountKitReport blobj;
                blobj = new BL_WallMountKitReport();
        ...
        private void ShowGridData()
        {
            try
            {
                string sWallMountKitBarcode = string.Empty;
                ...
                {
                    sWallMountKitBarcode = txtbarcode.Text.Trim();
                }
                CommonHelper.HideMessage(msginfo, msgsuccess, msgwarning, msgerror);
                BL_WallMountKitReport blobj = new BL_WallMountKitReport();
                DataTable dtTrackingData = blobj.GetReport(txtFromDate.Text, txtToDate.Text, drpFGItemCode.Text, sWallMountKitBarcode);
                if (dtTrackingData.Rows.Count > 0)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WallMountKitReport.rdlc");
