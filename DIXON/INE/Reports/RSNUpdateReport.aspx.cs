...
{
    public partial class RSNUpdateReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string _strRights = CommonHelper.GetRights("RSN Update Report", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void ShowGridData()
        {
            try
            {
                ...
                BL_RSNUpdate_Report blobj = new BL_RSNUpdate_Report();
                DataTable dtTrackingData = blobj.GetReport(txtFromDate.Text, txtToDate.Text, sRSN);
                if (dtTrackingData.Rows.Count > 0)
                {
                    ...
                    CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtMessage,
                          System.Reflection.MethodBase.GetCurrentMethod().Name, "RSN Update Report No of records :" + dtTrackingData.Rows.Count);

                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportDataSource datasource = new ReportDataSource();
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WIPRSNUpdateReport.rdlc");
