...
{
    public partial class ODUReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["Name"] != null && Request.QueryString["Name"] != string.Empty)
            {
                ...
                if (Request.QueryString["Name"].Contains("ODU"))
                {
                    lblHeader.Text = "ODU REPORT";
                }
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lblHeader.Text.StartsWith("ODU"))
                {
        ...
        private void ShowGridData()
        {
            try
            {
                ...
                BL_ODU blobj = new BL_ODU();
                DataTable dtTrackingData = blobj.GetReportODU(txtPONO.Text.Trim(), dropreporttype.SelectedValue);
                ...
                else
                {
                    ...
                    //txtPONO.Text = Regex.Replace(txtPONO.Text, "[\\//|*:?<>\"]", "");
                    //string sFileName = dropreporttype.SelectedValue.ToString().Trim() + "_" +
                    //    txtPONO.Text.Trim() + DateTime.Now.ToString("_dd_MM_yyyy"); 
                    //DataTable copyDataTable = dtTrackingData.Copy(); 
                    ...
                    //    using (XLWorkbook wb = new XLWorkbook())
                    //    { 
                    //        wb.Worksheets.Add(copyDataTable, sFileName);
                    //        string myName = Server.UrlEncode(sFileName + ".xlsx");
                    //        System.IO.MemoryStream stream = GetStream(wb);// The method is defined below
                    //        Response.Clear();
                    //        Response.Buffer = true;
