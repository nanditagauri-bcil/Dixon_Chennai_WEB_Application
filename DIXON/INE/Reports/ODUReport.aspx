<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ODUReport.aspx.cs" Inherits="DIXON.INE.Reports.ODUReport" %>
                        ...
                        <div class="col-md-6">
                               <div class="form-group">
                                ...
                                <asp:DropDownList ID="dropreporttype" runat="server"
                                    ...
                                    <asp:ListItem>BT MAC</asp:ListItem> 
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
