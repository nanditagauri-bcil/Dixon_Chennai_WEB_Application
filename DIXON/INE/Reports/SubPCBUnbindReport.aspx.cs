...
{
    public partial class SubPCBUnbindReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string _strRights = CommonHelper.GetRights("SUB PCB Unbind Report", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindFGItemCode()
        {
            try
            {
                BL_SubPCB_Unbind_Report blobj;
                blobj = new BL_SubPCB_Unbind_Report();
        ...
        private void ShowGridData()
        {
            try
            {
                ...
                BL_SubPCB_Unbind_Report blobj = new BL_SubPCB_Unbind_Report();
                DataTable dt = blobj.GetReport(txtFromDate.Text, txtToDate.Text, sPCBID
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtMessage,
                          System.Reflection.MethodBase.GetCurrentMethod().Name, "SUB PCB Unbind Report No of records :" + dt.Rows.Count);

                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportDataSource datasource = new ReportDataSource();
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WIPSubPCBUnbindReport.rdlc");
