<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RSNUpdateReport.aspx.cs"
    Inherits="DIXON.INE.Reports.RSNUpdateReport" %>
                ...
                <div class="box-body">
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                <label>RSN Scan</label>
                                <asp:TextBox ID="txtrsn" runat="server" class="form-control" Style="width: 100%;">                                 
                                </asp:TextBox>
                            </div>
                        </div>
                    </div>
