...
{
    public partial class WIPHoldPartReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["usertype"].ToString() != "ADMIN")
            {
                string _strRights = CommonHelper.GetRights("WIP Hold Part Report", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindPart_No()
        {
            try
            {
                BL_WIPHoldPartReport blobj;
                blobj = new BL_WIPHoldPartReport();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = blobj.GetWIPHoldPartReport(drpFGitemCode.SelectedItem.Text.Trim(),
                ...
                else
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WIPHoldPartReport.rdlc");
