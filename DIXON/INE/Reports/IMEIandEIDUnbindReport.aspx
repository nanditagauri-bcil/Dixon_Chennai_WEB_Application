<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="IMEIandEIDUnbindReport.aspx.cs"
    Inherits="DIXON.INE.Reports.IMEIandEIDUnbindReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>IMEI&EID / CHIPID Unbind Report</h1>
        </section>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtmacid" runat="server" class="form-control" Style="width: 100%;">                                 
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtimei" runat="server" class="form-control" Style="width: 100%;">                                 
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txteid" runat="server" class="form-control" Style="width: 100%;">                                 
                                </asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtchipid" runat="server" class="form-control" Style="width: 100%;">                                 
                                </asp:TextBox>
                            </div>
                        </div>
                    </div>
