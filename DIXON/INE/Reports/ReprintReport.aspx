<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReprintReport.aspx.cs" Inherits="DIXON.INE.Reports.ReprintReport" %>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpType" runat="server" class="form-control select2" Style="width: 100%;">
                                    ...
                                    <asp:ListItem>WIP PCB LABEL</asp:ListItem>
