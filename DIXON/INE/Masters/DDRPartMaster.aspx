<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DDRPartMaster.aspx.cs" 
    Inherits="DIXON.INE.Masters.DDRPartMaster" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">DDR Part Master</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Label ID="lblModelName" Enabled="false" runat="server"
                                    class="form-control flat" Style="width: 100%;" >                                 
                                </asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtBomPart" runat="server"  
                                    class="form-control" placeholder="Enter BOM Part Code"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>DDR Part Code : </label>
                                <asp:TextBox ID="txtDDRPart" runat="server"  
                                    class="form-control" placeholder="Enter DDR Part Code"></asp:TextBox>                                 
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>DDR Description : </label>
                                <asp:TextBox ID="txtDDRDesc" runat="server" MaxLength="30"
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <asp:GridView ID="gvDDRMaster" runat="server"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Line ID" DataField="LINE_CODE" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300" />
                                        <asp:BoundField HeaderText="FG Item Code" DataField="FG_ITEM_CODE" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="500" />
                                        <asp:BoundField HeaderText="BOM Part Code" DataField="BOM_PART_CODE" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="900" />
                                        <asp:BoundField HeaderText="DDR Part Code" DataField="DDR_PART_CODE" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="900" />
                                        <asp:BoundField HeaderText="Description" DataField="DESCRIPTIONS" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="900" />
