...
namespace DIXON.Helper
{
    public static class DynamicRDLCGenerator
    {
        public static MemoryStream GenerateReport(DataTable dt, string reportTitle)
        {
            ...
            // 1. Report Start & Page Settings (FIXED: Set to Standard A4 Landscape)
            // A4 Landscape: Width 29.7cm, Height 21cm
            // Report Body Width: 29.7cm - 1cm (margins) = ~28.7cm
  ...
  <DataSources>
    ...
    <ReportParameter Name='rptGeneratedOn'><DataType>String</DataType><Nullable>true</Nullable><AllowBlank>true</AllowBlank><Prompt>GeneratedOn</Prompt></ReportParameter>
            ...
            <Textbox Name='txtGenBy'>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
                    <TextRun>
                       <Value>=""Generated By: "" &amp; Parameters!rptGeneratedBy.Value &amp; vbCrLf &amp; ""On: "" &amp; Parameters!rptGeneratedOn.Value</Value>
          ...
          <Height>1.8cm</Height><Width>28cm</Width>
            ...
            // Fixed: Reduced column width to 3.0cm so 9 columns fit ~27cm (within 28cm page width)
            rdl.Append(@"<TablixBody><TablixColumns>");
            foreach (DataColumn col in dt.Columns)
            {
                rdl.Append(@"<TablixColumn><Width>3.0cm</Width></TablixColumn>");
            }
            ...
            {
                string colName = CleanName(col.ColumnName);
                rdl.AppendFormat(@"<TablixCell><CellContents><Textbox Name='D_{0}'><Paragraphs><Paragraph><TextRuns><TextRun><Value>=Fields!{0}.Value</Value><Style /></TextRun></TextRuns><Style><TextAlign>Left</TextAlign></Style></Paragraph></Paragraphs><Style><Border><Color>LightGrey</Color><Style>Solid</Style></Border><PaddingLeft>2pt</PaddingLeft><PaddingRight>2pt</PaddingRight><PaddingTop>2pt</PaddingTop><PaddingBottom>2pt</PaddingBottom></Style></Textbox></CellContents></TablixCell>", colName);
            }
            rdl.Append(@"</TablixCells></TablixRow>");
