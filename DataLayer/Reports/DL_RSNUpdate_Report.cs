...
{
    public class DL_RSNUpdate_Report
    {
        DBManager oDbm;
        public DL_RSNUpdate_Report()
        {
        ...
        public DataTable GetReport(string sFromDate, string sTODate, string sRSN)
        {
            ...
            try
            {
                ...
                oDbm.AddParameters(3, "@RSN", sRSN);
                dtResult = oDbm.ExecuteDataSet(CommandType.StoredProcedure, "USP_RSNUPDATE_REPORT").Tables[0];
            }
            catch (Exception ex)
            {
