...
{
    public class DL_WIPRsn_And_MacID_Mapping_Report
    {
        DBManager oDbm;
        public DL_WIPRsn_And_MacID_Mapping_Report()
        {
        ...
        public DataTable BindFGItemCode(string sSiteCode)
        {
            ...
            try
            {
                ...
                dtResult = oDbm.ExecuteDataSet(CommandType.StoredProcedure, "USP_WIPRsn_And_MacID_Mapping_Report").Tables[0];
            }
            catch (Exception ex)
            {
