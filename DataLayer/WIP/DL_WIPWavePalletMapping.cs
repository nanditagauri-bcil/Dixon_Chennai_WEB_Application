...
{
    public class DL_WIPWavePalletMapping : DCommon
    {
        DBManager odb;
        DataTable dtobj;
        public DL_WIPWavePalletMapping()
        {
            odb = SqlDBProvider();
        }
        ...
        public DataTable ValidateMachine(string sMachineID, string sSiteCode, string sLineCode)
        {
            ...
            try
            {
                ...
                odb.Open();
                dt = odb.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "USP_WIP_WAVE_PALLET_MAPPING").Tables[0];
            }
            catch (Exception ex)
            {
        ...
        public DataTable BindSubPCBID(string sFGitemCode, string sSiteCode)
        {
            ...
            try
            {
                ...
                odb.AddParameters(2, "@SITECODE", sSiteCode);
                odb.Open();
                dtobj = odb.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "USP_WIP_WAVE_PALLET_MAPPING").Tables[0];
            }
            catch (Exception ex)
            {
            ...
            , string sSiteCode, string sLineCode)
        {
            ...
            try
            {
                ...
                dtResult = odb.ExecuteDataSet(CommandType.StoredProcedure, "USP_WIP_WAVE_PALLET_MAPPING");
            ...
            string sWavePalletID, string sSiteCode, string sUserID, string sLineCode)
        {
            ...
            try
            {
                ...
                odb.AddParameters(4, "@MAPPEDBY", sUserID);
                odb.AddParameters(5, "@WAVE_PALLETID", sWavePalletID);
                odb.AddParameters(6, "@SITECODE", sSiteCode);
                odb.AddParameters(7, "@TYPE", "VALIDATEWAVEID");
                dtResult = odb.ExecuteDataSet(CommandType.StoredProcedure, "USP_WIP_WAVE_PALLET_MAPPING").Tables[0];
             ...
             , string sLineCode, string sFGItemCode, string sUserID, string sWavePalletID, DataTable _dtSubPCBIDs)
        {
            ...
            try
            {
                ...
                odb.AddParameters(9, "@WAVE_PALLETID", sWavePalletID);
                dtResult = odb.ExecuteDataSet(CommandType.StoredProcedure, "USP_WIP_WAVE_PALLET_MAPPING").Tables[0];
